 ...
 */
public class UserAlbum4Fragment extends Fragment {


    LinearLayout back;
    public UserAlbum4Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_user_album4, container, false);
    }
    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        images.add(R.mipmap.album41);
        images.add(R.mipmap.album42);
