 ...
 */
public class UserAlbum3Fragment extends Fragment {


    LinearLayout back;
    public UserAlbum3Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_user_album3, container, false);
    }
    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        images.add(R.mipmap.album31);
        images.add(R.mipmap.album32);
