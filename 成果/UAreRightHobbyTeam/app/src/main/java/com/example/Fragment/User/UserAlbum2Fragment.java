 ...
 */
public class UserAlbum2Fragment extends Fragment {


    LinearLayout back;
    public UserAlbum2Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_user_album2, container, false);
    }
    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        images.add(R.mipmap.album21);
        images.add(R.mipmap.album22);
