 ...
 */
public class ActivityListReportFragment extends Fragment {


    private ListView teamListview;
    private Button backBtn;

    public ActivityListReportFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_activity_list_report, container, false);
    }
    ...
    private void initData(){
        ...
        List<String> stringList = BmobUser.getCurrentUser(UserInfo.class).getReportTeamIds();
