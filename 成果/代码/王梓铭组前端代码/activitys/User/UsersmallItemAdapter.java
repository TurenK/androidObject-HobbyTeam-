                    ...
                    public void done(List<Friends> list, BmobException e) {
                        if(e==null){
                            if(list!=null&&!list.isEmpty()){
                                final List<Friends> listtemp = list;
                                AlertDialog.Builder builder = new AlertDialog.Builder(mActivity);
                                builder.setTitle("确定删除好友吗？").setNegativeButton("取消", new DialogInterface.OnClickListener() {
                                    @Override
                                ...
                                builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        listtemp.get(0).delete(listtemp.get(0).getObjectId(), new UpdateListener() {
                                            @Override
