 ...
 */
public class ActivityListJoininFragment extends Fragment {


    private ListView teamListview;
    private Button backBtn;

    public ActivityListJoininFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_activity_list_joinin, container, false);
    }
    ...
    private void initData(){
        ...
        List<String> stringList = BmobUser.getCurrentUser(UserInfo.class).getJoinedTeamIds();
