 ...
 */
public class ActivityListCollectFragment extends Fragment {


    private ListView teamListview;
    private Button backBtn;

    public ActivityListCollectFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_activity_list_collect, container, false);
    }
    ...
    private void initData(){
        ...
        List<String> stringList = BmobUser.getCurrentUser(UserInfo.class).getCollectTeamIds();
            ...
            public void done(List<Activitys> list, BmobException e) {
                if(e==null){
                    if(list!=null&&!list.isEmpty()){
                        ...
                        Toast.makeText(getActivity(),"查询失败", LENGTH_SHORT).show();
                    }
                }else{
