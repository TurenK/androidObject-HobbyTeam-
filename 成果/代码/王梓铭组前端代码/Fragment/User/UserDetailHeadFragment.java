        ...
        userDetailHeadCameraBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Environment.getExternalStorageState().equals(
                    ...
                    file = new File(getActivity().getExternalCacheDir(), "userdetailheadtemp.jpeg");
                }else{
                    file= new File(getActivity().getCacheDir(), "userdetailheadtemp.jpeg");
                }
                try {
                    if (file.exists())
                        file.delete();
        ...
        switch (requestCode) {
            ...
            case CAM: {
                if (resultCode == getActivity().RESULT_OK) {
                    //获得返回数据
                    userDetailHeadUserImgView.setImageURI(null);
                    userDetailHeadUserImgView.setImageURI(imageUri);
                    if (Environment.getExternalStorageState().equals(
                            Environment.MEDIA_MOUNTED)) {//判断是否已经挂载
                        picturePath = new File(getActivity().getExternalCacheDir(), "userdetailheadtemp.jpeg").getPath();
                    }else{
